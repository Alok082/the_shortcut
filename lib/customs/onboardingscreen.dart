...
class _OnboardingScreenState extends State<OnboardingScreen> {
  final List<OnboardingPage> pages = [
    OnboardingPage(
      // change these image for onboarding before use 
      image: 'assets/2.png',
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                  // give here height according to need
                  height: 23,
                ),
                Align(
                ...
                Align(
                  ...
                  child: CustomButton(
                    ...
                    buttoncolor: const Color.fromARGB(255, 66, 8, 8),
                    buttonaction: () {
                      nextPage();
                    },
                    button_name:
...
// customize dot indicator your self
